...
# for TFA9894 Smart PA
ifdef CONFIG_SND_SOC_TFA9894
	TFA9894_OBJS += src/tfa98xx.o
	TFA9894_OBJS += src/tfa_container.o
	TFA9894_OBJS += src/tfa_dsp.o
	TFA9894_OBJS += src/tfa_init.o
endif
...
obj-$(CONFIG_SND_SOC_TFA9894) += tfa9894_dlkm.o
tfa9894_dlkm-y := $(TFA9894_OBJS)
